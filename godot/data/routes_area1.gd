class_name RoutesArea1

static func get_routes() -> Array:
	return [
		{
			"id": "cc1", "name": "Monkey Arms", "grade": "V1", "holdCount": 8,
			"description": "Reach wide to start and move up good holds to the finish", "startCol": 3,
			"holds": [
		...
		{
			"id": "cc2", "name": "Reach a Cross", "grade": "V2", "holdCount": 8,
			"description": "Pockets down low lead to a reachy pinch move up top", "startCol": 1,
			"holds": [
		...
		{
			"id": "cc3", "name": "Careful Planning", "grade": "V2", "holdCount": 9,
			"description": "Survive tenuous holds to reach for a juggy end", "startCol": 4,
			"holds": [
